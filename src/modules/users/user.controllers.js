...
export async function signUp(req, res) {
  try {
    ...
    if (user.hasOwnProperty("errors")) {
      ...
      utilities.sendResponse(HTTPStatus.OK, {message: "Ask admin to approve your account."}, res);
    }
  } catch (er) {
...
export function login(req, res, next) {
  if (!req.user.emailConfirm) {
    ...
    utilities.sendResponse(HTTPStatus.OK, {data: "Please verify your email address first."}, res);
  } else if (!req.user.adminConfirm && req.user.emailConfirm) {
    utilities.sendResponse(HTTPStatus.OK, {data: "Your profile is awaiting for administrator approval."}, res);
  } else if (req.user.adminConfirm && req.user.emailConfirm) {
    utilities.sendResponse(HTTPStatus.OK, req.user.onSuccess(), res);
  }
  return next();
}
...
export async function getAllUsers(req, res) {
  try {
    ...
    if (data.hasOwnProperty("errors")) {
      utilities.sendErrorResponse(HTTPStatus.BAD_REQUEST, true, utilities.getErrorDetails(data.errors), res);
    } else {
      utilities.sendResponse(HTTPStatus.OK, data, res);
    }
  } catch (er) {
