...
async function createPatient(req, res) {
  try {
    const { name, dob, email, contact, address, city, state, disease, history, prescription, doctorId, clientId } = req.body;
    ...
    try {
      ...
      const treatmentPrompts = {
        'IMPLANTS': [
          ...
          "6) CRITICAL: Do NOT alter lips - maintain exact original lip color, shape, texture, and fullness.",
          "7) CRITICAL: If a cheek retractor or mouth prop is visible, keep it in the EXACT same position - do not move, remove, or alter it.",
          "8) CRITICAL: Do NOT increase age appearance - maintain the exact same youthfulness and age of the person and teeth.",
          "9) CRITICAL: Do NOT increase the size or shape of teeth - maintain original tooth dimensions and proportions.",
          "CRITICAL RULE – Apply ONLY dental implant treatment.",
          "Do NOT whiten teeth, redesign the smile, straighten teeth, close gaps, or simulate braces or veneers.",
          "Any mixing of treatments is INVALID.",
          "Return a single photorealistic edited image showing successful implant placement.",
          "FINAL VALIDATION CHECK:",
          "Before returning the image, internally verify:",
          "- Only the requested treatment is visible.",
          "- No visual indicators of other treatments exist.",
          "- Lips are unchanged in color, shape, and texture.",
          "- Cheek retractor or mouth prop (if present) remains in exact original position.",
          "- The person's age and youthfulness are unchanged.",
          "- Teeth size and shape remain consistent with the original.",
          "If any other treatment indicators are present, DO NOT return the image and regenerate."
        ].join(' '),
        'SMILE DESIGNING': [
          "You are a professional dental image editor. Using the provided photo of a patient's smile,",
          "generate a realistic 'after' result showing complete smile makeover with these constraints:",
          "1) CRITICAL AGE CHECK: If the patient appears to be a child or has primary (baby) teeth visible, DO NOT apply any treatment. Children's teeth are temporary and will naturally be replaced. Return the original image unchanged with a note that smile design is not applicable for children.",
          "2) Create perfectly aligned, symmetrical, and proportionate teeth (only for adults/teenagers with permanent teeth).",
          "3) Apply subtle tooth whitening for a bright, natural Hollywood smile.",
          "4) Fix gaps, crowding, and uneven edges for an aesthetically pleasing smile.",
          "5) Preserve patient identity: do NOT alter facial features, skin tone, or change hair.",
          "6) Ensure teeth look natural, not artificially white. Keep lighting & shadows realistic.",
          "7) CRITICAL: Do NOT alter lips - maintain exact original lip color, shape, texture, and fullness.",
          "8) CRITICAL: If a cheek retractor or mouth prop is visible, keep it in the EXACT same position - do not move, remove, or alter it.",
          "9) CRITICAL: Do NOT increase age appearance - maintain the exact same youthfulness and age of the person and teeth.",
          "10) CRITICAL: Do NOT increase the size or shape of teeth beyond natural proportions - maintain realistic tooth dimensions.",
          "CRITICAL RULE – Apply ONLY smile designing treatment to adults/teenagers with permanent teeth.",
          "Do NOT add implants, braces results, whitening-only effects, or surgical dental work.",
          "Do NOT apply treatment to children with primary teeth.",
          "Any mixing of treatments is INVALID.",
          "Return a single photorealistic edited image showing a beautiful designed smile.",
          "FINAL VALIDATION CHECK:",
          "Before returning the image, internally verify:",
          "- Patient appears to be an adult or teenager with permanent teeth (not a child with baby teeth).",
          "- Only the requested treatment is visible.",
          "- No visual indicators of other treatments exist.",
          "- Lips are unchanged in color, shape, and texture.",
          "- Cheek retractor or mouth prop (if present) remains in exact original position.",
          "- The person's age and youthfulness are unchanged.",
          "- Teeth size and shape remain natural and proportionate.",
          "If the patient is a child or if any other treatment indicators are present, DO NOT return the image and regenerate."
        ].join(' '),
        'TEETH WHITENING': [
          "You are a professional dental image editor. Using the provided photo of a patient's smile,",
          ...
          "5) Do NOT change tooth alignment, gaps, spacing, or add any other dental work.",
          "6) CRITICAL: Do NOT alter lips - maintain exact original lip color, shape, texture, and fullness.",
          "7) CRITICAL: If a cheek retractor or mouth prop is visible, keep it in the EXACT same position - do not move, remove, or alter it.",
          "8) CRITICAL: Do NOT increase age appearance - maintain the exact same youthfulness and age of the person and teeth.",
          "9) CRITICAL: Do NOT change the size or shape of teeth - maintain exact original tooth dimensions.",
          "CRITICAL RULE – Apply ONLY teeth whitening.",
          "Do NOT alter alignment, shape, spacing, add implants, braces effects, veneers, or smile redesign.",
          "Any mixing of treatments is INVALID.",
          ...
          "- Cheek retractor or mouth prop (if present) remains in exact original position.",
          "- The person's age and youthfulness are unchanged.",
          "- Teeth size and shape are exactly as in the original image.",
          "If any other treatment indicators are present, DO NOT return the image and regenerate."
        ].join(' '),
        'BRACES': [
          "You are a professional dental image editor. Using the provided photo of a patient's smile,",
          ...
          "7) CRITICAL: If a cheek retractor or mouth prop is visible, keep it in the EXACT same position - do not move, remove, or alter it.",
          "8) CRITICAL: Do NOT increase age appearance - maintain the exact same youthfulness and age of the person and teeth.",
          "9) CRITICAL: Do NOT increase the size or shape of teeth - maintain original tooth dimensions, only adjust alignment.",
          "CRITICAL RULE – Apply ONLY orthodontic alignment results.",
          "Do NOT whiten teeth, add implants, veneers, smile redesign, or cosmetic enhancements.",
          "Any mixing of treatments is INVALID.",
          ...
          "- Cheek retractor or mouth prop (if present) remains in exact original position.",
          "- The person's age and youthfulness are unchanged.",
          "- Teeth size and shape remain consistent, only alignment has changed.",
          "If any other treatment indicators are present, DO NOT return the image and regenerate."
        ].join(' ')
      };
    ...
    const milestones = [
      {
        ...
        percentage: 25,
        prompt: [
          "You are a professional dental image editor. Using the provided photo, generate a realistic '10 Days' treatment progress image under STRICT dental realism rules.",
          "ABSOLUTE CONSTRAINTS:",
          " This is ONLY 10–15% progress. If the result looks obviously improved, it is WRONG.",
          " Do NOT create a visibly better smile.",
          " Do NOT make the teeth look straight.",
          " Do NOT create a 'before/after' difference.",
          "ALLOWED CHANGES (VERY LIMITED):",
          "Alignment:",
            "Teeth positions must remain almost identical.",
            "Maximum movement per tooth: 0.5–1 mm ONLY.",
            "Crowding and gaps must still be clearly visible.",
          "Whitening:",
            "Maximum 1 shade lighter.",
            "Whitening must be subtle enough to be mistaken for lighting variation.",
          "Smile design:",
            "ONLY micro-smoothing of 1–2 tooth edges.",
            "No reshaping, no size changes, no symmetry correction.",
          "LOCKED ELEMENTS (MUST NOT CHANGE):",
          "Tooth count, tooth width, tooth height",
          "Gum line, gum color, lip position",
          "Bite, arch shape, facial expression",
          "Camera angle, lighting, shadows",
          "REALISM RULE:",
          "This should look like the patient just started treatment and most people would say I don’t see much difference yet.",
          "Return a photorealistic image showing extremely early-stage treatment with minimal, barely noticeable change.",
        ].join(' ')
      },
      {
        month: 3,
        percentage: 50,
        prompt: [
          "You are a professional dental image editor. Using the provided photo, generate a realistic 'Month 3' dental treatment progress image following STRICT medical realism.",

        "ABSOLUTE CONSTRAINTS:",
        " Progress must NOT exceed 40%.",
        " Teeth must NOT look fully straight or finished.",
        " Original dental problems must still be noticeable.",

        "ALLOWED CHANGES:",
        " Alignment:",
        " Partial alignment only.",
        " Gaps and crowding reduced by approximately 30–40%.",
        " Some teeth must still appear misaligned.",

        " Whitening:",
        " 2 shades lighter maximum.",
        " Teeth must still look slightly yellow/off-white.",
        " Smile design:",
        " Minor symmetry improvement only.",
        " Edge smoothing on a few teeth, not all.",
        " No cosmetic perfection.",

        "LOCKED ELEMENTS:",
        " Facial features, lips, gums, bite",
        " Tooth shape proportions",
        " Lighting, shadows, camera framing",

        "REALISM RULE:",
        " This should look like visible improvement, but clearly unfinished dental work.",    
        "Return a photorealistic image showing conservative, in-progress treatment results."
        ].join(' ')
      },
      {
        month: 6,
      ...
      },
      {
        ...
        percentage: 100,
        prompt: [
          "You are a professional dental image editor. Using the provided photo, generate a realistic 'Month 6' dental treatment progress image.",
            "ABSOLUTE CONSTRAINTS:",
            "- Results should look almost complete but NOT perfect.",
            "- Minor imperfections must still exist.",

            "ALLOWED CHANGES:",
            "Alignment:",
            "- Teeth mostly straight.",
            "- Very small misalignments or spacing still visible.",

            "Whitening:",
            "- Bright white, but natural.",  
            "- No 'Hollywood glow' yet.",

            "Smile design:",
            "- Strong symmetry and proportion.",
            "- Fine adjustments still pending.",

            "LOCKED ELEMENTS:",
            "- Face, lips, gums, lighting, camera angle",
            "- Tooth count and natural texture",

            "REALISM RULE:",
            "- A dentist would say: 'Almost done, just fine-tuning left.",
            "Return a photorealistic image showing advanced but unfinished treatment."
        ].join(' ')
      }
    ];
