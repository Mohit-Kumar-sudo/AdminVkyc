...
module.exports = {
    ...
    create: async (req, res, next) => {
        try {
            ...
            if (result) {
                const resData = await Model.find({ is_active: true }, { keyName: 1, percentage: 1 })
                let newData = []
                ...
                try {
                    ...
                    axios.post('http://20.219.158.85:6066/api/vkyc/controlpanel/matching', result , config)
                        .then((response) => {
        ...
        try {
            ...
            if (result) {
                ...
                try {
                    ...
                    axios.post('http://20.219.158.85:6066/api/vkyc/controlpanel/matching', newResult , config)
                        .then((response) => {
                            if (response.data.status == 'succces') {
                                res.send({ success: true, msg: 'Data submitted successfully' })
                            } else {
