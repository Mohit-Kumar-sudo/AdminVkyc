...
import { parentMarketAnalysisSections, MenuMetaData } from 'src/app/models/section-metadata';
...
@Component({
  selector: 'app-parent-market-analysis-new',
  templateUrl: './parent-market-analysis-new.component.html',
  styleUrls: ['./parent-market-analysis-new.component.scss']
})
export class ParentMarketAnalysisNewComponent implements OnInit {

  currentReport: MasterReportData = null;
  menuInputList: MenuMetaData[] = parentMarketAnalysisSections;
  ...
  ngOnInit() {
    ...
    /* let mainSection = this.reportMetadataService.getMainSectionByKey(MainSectionConstants.PARENT_MARKET_ANALYSIS)
