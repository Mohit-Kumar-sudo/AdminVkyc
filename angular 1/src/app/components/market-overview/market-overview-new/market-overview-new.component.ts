...
import { marketOverviewSections, MenuMetaData } from 'src/app/models/section-metadata';
...
@Component({
  selector: 'app-market-overview-new',
  templateUrl: './market-overview-new.component.html',
  styleUrls: ['./market-overview-new.component.scss']
})
export class MarketOverviewNewComponent implements OnInit {

  currentReport: MasterReportData = null;
  menuInputList: MenuMetaData[] = marketOverviewSections;
  ...
  ngOnInit() {
    ...
    /* let mainSection = this.reportMetadataService.getMainSectionByKey(MainSectionConstants.MARKET_OVERVIEW)
