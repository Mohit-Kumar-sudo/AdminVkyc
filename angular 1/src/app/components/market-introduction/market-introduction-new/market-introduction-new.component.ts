...
@Component({
  ...
  templateUrl: './market-introduction-new.component.html',
  styleUrls: ['./market-introduction-new.component.scss']
})
export class MarketIntroductionNewComponent implements OnInit {
