...
import { MenuMetaData, bransShareAnalysisSections } from 'src/app/models/section-metadata';
...
@Component({
  selector: 'app-brand-share-analysis-new',
  templateUrl: './brand-share-analysis-new.component.html',
  styleUrls: ['./brand-share-analysis-new.component.scss']
})
export class BrandShareAnalysisNewComponent implements OnInit {

  currentReport: MasterReportData = null;
  menuInputList: MenuMetaData[] = bransShareAnalysisSections;
  ...
  ngOnInit() {
    ...
    /* let mainSection = this.reportMetadataService.getMainSectionByKey(MainSectionConstants.BRAND_SHARE_ANALYSIS)
