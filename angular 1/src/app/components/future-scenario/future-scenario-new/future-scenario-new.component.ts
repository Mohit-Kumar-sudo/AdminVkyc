...
import { MenuMetaData, futureScenarioSections } from 'src/app/models/section-metadata';
...
@Component({
  selector: 'app-future-scenario-new',
  templateUrl: './future-scenario-new.component.html',
  styleUrls: ['./future-scenario-new.component.scss']
})
export class FutureScenarioNewComponent implements OnInit {

  currentReport: MasterReportData = null;
  menuInputList: MenuMetaData[] = futureScenarioSections;
  ...
  ngOnInit() {
    ...
    /* let mainSection = this.reportMetadataService.getMainSectionByKey(MainSectionConstants.FUTURE_SCENARIO)
