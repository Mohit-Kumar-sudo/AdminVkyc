...
import { MenuMetaData, pricingAnalysisSections } from 'src/app/models/section-metadata';
...
@Component({
  selector: 'app-pricing-analysis-new',
  templateUrl: './pricing-analysis-new.component.html',
  styleUrls: ['./pricing-analysis-new.component.scss']
})
export class PricingAnalysisNewComponent implements OnInit {

  currentReport: MasterReportData = null;
  menuInputList: MenuMetaData[] = pricingAnalysisSections;
  ...
  ngOnInit() {
    ...
    /* let mainSection = this.reportMetadataService.getMainSectionByKey(MainSectionConstants.PRICING_ANALYSIS)
