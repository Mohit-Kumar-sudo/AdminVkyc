...
export async function getReports(req, res) {
  try {
    // Generate a unique cache key based on the function name and user details
    const cacheKey = `getReports:${req.user._id}`;
    ...
    // If data is not found in the cache, fetch it from MongoDB
...
export async function fetchReport(req, res) {
  try {
    ...
    console.log("Fetching report data from the service", reportId);
